...
class des():
    ...
    def run(self, key, text, action=ENCRYPT, padding=False):
        ...
        if padding and action==DECRYPT:
            ...
            return final_res,bitseq #Return the final string of data ciphered/deciphered
...
if __name__ == '__main__':
   ...
   for k in range(100):
        ...
        x=randint(0,7)
        key2=list(key1)
        key2[x]=chr(ord(key2[x]) + 1)
        key2="".join(key2)
        text1= "JagroopB"
        # text2 = "JagroopA"
        print(k+1,": key1=",key1,", key2=",key2,", text=",text1,end="")

        d = des()
        r1,bs1 = d.encrypt(key1,text1)
        r2,bs2 = d.encrypt(key2,text1)
        #r2 = d.decrypt(key,r)
        # print ("Ciphered: %r" % r1)
        # print("Ciphered: %r" % r2)
        dbits=[]
        ...
        #print ("Deciphered: ", r2)
        print(", avg change in last bit=", change[15]/(k+1))
   for i in range(16):
       print("Round ",i+1,": ",change[i]/100)
